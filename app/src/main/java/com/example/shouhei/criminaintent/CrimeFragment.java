...
import static com.example.shouhei.criminaintent.CrimeListFragment.*;
...
public class CrimeFragment extends Fragment {
          ...
          public void onClick(View v) {
            ...
            Intent i =
                ShareCompat.IntentBuilder.from(getActivity())
                    ...
                    .setChooserTitle(getString(R.string.send_crime_report))
                    .getIntent();
          ...
          public void onClick(View v) {
            Uri uri =
                FileProvider.getUriForFile(
                    getActivity(), "com.example.shouhei.criminalintent.fileprovider", mPhotoFile);
  ...
  private String getCrimeReport() {
    ...
    //    String dateString = DateFormat.format(dataFormat, mCrime.getDate());
